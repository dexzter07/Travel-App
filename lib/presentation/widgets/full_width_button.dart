...
class FullWidthButton extends StatelessWidget {
  ...
  FullWidthButton({required this.title,required this.color,required this.onTap,required this.borderRadius,required this.border,required this.padding,required this.margin});
