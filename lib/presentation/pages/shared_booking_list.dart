...
class _SharedBookingListState extends State<SharedBookingList> {
  final AvailDayTourCabSharedController _availDayTourCabSharedController =
      Get.put(AvailDayTourCabSharedController());
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Obx(
          () => _availDayTourCabSharedController.isLoading.value == true
              ? Center(
              ...
              : ListView.builder(
                  itemCount:
                      _availDayTourCabSharedController.availSharedCab.length,
                  itemBuilder: (context, index) {
                    return SharedBookingComponent(
                      availDayTourSharedCabModel:
                          _availDayTourCabSharedController
                              .availSharedCab[index],
                    );
                  },
                ),
        ));
